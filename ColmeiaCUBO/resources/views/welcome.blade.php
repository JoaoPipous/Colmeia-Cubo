...
@section('content')
    <section
        class="select-none relative overflow-hidden bg-gradient-to-b from-blue-50 via-transparent to-transparent pb-12 pt-20 sm:pb-16 sm:pt-32 lg:pb-24 xl:pb-32 xl:pt-40">
        ...
        <div class="relative z-20 mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                    NPI - COLMEIA CUBO
                    <span class="text-[#f08223] text-4xl font-semibold">Gerenciador de Cursos & Unidades Curriculares
                    </span>
                </h1>
                    ...
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ route('cursos.index') }}" wire:navigate
                                class="isomorphic-link isomorphic-link--internal inline-flex items-center justify-center gap-2 rounded-xl bg-[#f08223] px-4 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-150 hover:bg-[#f08323c6] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f08223]
                                hover:-translate-x-1 hover:-translate-y-1 hover:shadow-[3px_3px_rgba(240,_130,_35,_0.4),_7px_7px_rgba(240,_130,_35,_0.3),_10px_10px_rgba(240,_130,_35,_0.2)]
                                "
            ...
            <div class="relative mx-auto mt-10 max-w-lg">
                <img draggable="false" class="max-w-[80%] mx-auto rounded-2xl border border-gray-100 shadow"
    ...
    <footer class="flex flex-col space-y-10 justify-center m-10">
        ...
        <p class="text-center text-gray-700 font-medium">&copy; 2024 Unifil. Todos os Direitos Reservados.</p>
    </footer>
@endsection
